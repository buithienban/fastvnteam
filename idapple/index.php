...
<body>
    <div class="container"><i class="fas fa-exclamation-triangle"></i>
        ...
        <p>Vui Lòng Liên Hệ © <a href="https://t.me/buithienban" target="_blank">Dev BUI THIEN BAN</a></p>

        <p id="activation-message">Để Kích Hoạt Key</p>
        <button onclick="window.location='https://t.me/buithienban';">
